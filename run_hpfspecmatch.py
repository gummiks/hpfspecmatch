...
if __name__=='__main__':
    ...
    parser.add_argument("--savefolder",type=str,default="results",help="Specify foldername to save (e.g. results_123)")
    ...
    hpfspecmatch.run_specmatch_for_orders(filename, targetname, outputdir, path_df_lib=path_df_lib, orders=orders)
